import { useRef, useEffect, useState, type CSSProperties, type JSX } from "react";
...
const SplitText = ({
  ...
  const ref = useRef<HTMLElement & { _rbsplitInstance?: InstanceType<typeof GSAPSplitText> }>(
    null,
  );
  ...
  return (
    // @ts-expect-error -- ref is generic across intrinsic tag types
