...
export const translations = {
  ...
  "quickFacts.title": { zh: "通话常用信息", en: "Call reference" },
  "quickFacts.open": { zh: "打开通话常用信息", en: "Open call reference" },
  "quickFacts.close": { zh: "关闭", en: "Close" },
  "quickFacts.copy": { zh: "复制", en: "Copy" },
  "quickFacts.copied": { zh: "已复制", en: "Copied" },
  "quickFacts.empty": {
    zh: "还没有添加。在设置里加入 NPI、Tax ID、回电号码等打电话常用的信息。",
    en: "Nothing here yet. Add the details you read out on calls — NPI, tax ID, callback number — in Settings.",
  },
  "quickFacts.manage": { zh: "去设置里添加", en: "Add them in Settings" },
  "quickFacts.settingsTitle": { zh: "通话常用信息", en: "Call reference" },
  "quickFacts.settingsHint": {
    zh: "打电话时可以随时调出来念，不用离开当前页面。",
    en: "Pull these up during a call without leaving the page you're typing on.",
  },
  "quickFacts.label": { zh: "名称", en: "Label" },
  "quickFacts.value": { zh: "内容", en: "Value" },
  "quickFacts.labelPlaceholder": { zh: "例如 Group NPI", en: "e.g. Group NPI" },
  "quickFacts.valuePlaceholder": { zh: "例如 1234567890", en: "e.g. 1234567890" },
  "quickFacts.add": { zh: "添加", en: "Add" },
  "quickFacts.labelRequired": { zh: "请先填写名称和内容", en: "Enter a label and a value first" },
  "quickFacts.deleteConfirm": { zh: "删除「{label}」？", en: 'Delete "{label}"?' },
  "quickFacts.deletedToast": { zh: "已删除「{label}」", en: 'Deleted "{label}"' },
