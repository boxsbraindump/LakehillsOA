...
export const translations = {
  ...
  "vaRfs.vaFacilityPlaceholder": { zh: "留空就用下面存的默认值", en: "Leave blank to use the saved default" },
  "vaRfs.vaFacilityHint": { zh: "留空则用下面「诊所固定信息」里的默认值", en: "Blank falls back to the saved default below" },
  ...
  "vaRfs.cptHint": { zh: "留空则用默认值", en: "Blank falls back to the saved default" },
  "vaRfs.todaysDate": { zh: "22. 日期", en: "22. Today's date" },
  "vaRfs.reason": { zh: "18. 申请理由", en: "18. Reason for request" },
  "vaRfs.reasonHint": {
    zh: "留空就用默认那句。写多了会自动换行，不会超出格子。",
    en: "Blank uses the default sentence. Longer text wraps inside the box.",
  },
