...
export const translations = {
  ...
  "sidebar.vaRfs": { zh: "VA 表格", en: "VA forms" },

  "vaRfs.title": { zh: "VA 续诊申请表", en: "VA request for service" },
  "vaRfs.subtitle": {
    zh: "病人次数用完要重新申请时，填这几个空就能生成一份填好的 10-10172，打印签字即可。",
    en: "When a veteran runs out of visits, fill these few boxes and get a completed 10-10172 to print and sign.",
  },
  "vaRfs.patientSection": { zh: "这一次要填的", en: "This request" },
  "vaRfs.notStoredNote": {
    zh: "病人信息不会被保存 —— 生成 PDF 之后就没了，不进数据库。",
    en: "Nothing about the veteran is saved — it is typed, generated, and gone.",
  },
  "vaRfs.veteranName": { zh: "1. 病人姓名", en: "1. Veteran's name" },
  "vaRfs.veteranNamePlaceholder": { zh: "姓, 名", en: "Last, First" },
  "vaRfs.dateOfBirth": { zh: "2. 出生日期", en: "2. Date of birth" },
  "vaRfs.vaFacility": { zh: "3. VA 机构及地址", en: "3. VA facility & address" },
  "vaRfs.vaFacilityPlaceholder": { zh: "VA 机构名称及地址", en: "VA facility name and address" },
  "vaRfs.vaFacilityHint": { zh: "已带出默认值，这次要改就直接改，不影响下次", en: "Pre-filled from your default; editing it changes only this request" },
  "vaRfs.authorizationNumber": { zh: "4. VA 授权号", en: "4. VA authorization number" },
  "vaRfs.icd10": { zh: "13. 诊断代码 (ICD-10)", en: "13. Diagnosis code (ICD-10)" },
  "vaRfs.diagnosisDescription": { zh: "14. 诊断描述", en: "14. Diagnosis description" },
  "vaRfs.diagnosisPlaceholder": { zh: "如 Pain in shoulder", en: "e.g. Pain in shoulder" },
  "vaRfs.cptCodes": { zh: "15. CPT 码", en: "15. CPT/HCPCS code" },
  "vaRfs.cptHint": { zh: "已带出默认值，这次要改就直接改", en: "Pre-filled from your default; edit it for this request" },
  "vaRfs.todaysDate": { zh: "22. 日期", en: "22. Today's date" },
  "vaRfs.reason": { zh: "18. 申请理由", en: "18. Reason for request" },
  "vaRfs.reasonHint": {
    zh: "已带出默认那句，这次要改就直接改。写多了会自动换行，不会超出格子。",
    en: "Pre-filled with your default sentence; edit it for this request. Longer text wraps inside the box.",
  },
  "vaRfs.generate": { zh: "生成 PDF", en: "Generate PDF" },
  "vaRfs.clear": { zh: "清空", en: "Clear" },
  "vaRfs.reasonPlaceholder": {
    zh: "留空则这一格不印任何内容",
    en: "Leave blank to print nothing in this box",
  },
  "vaRfs.signHint": {
    zh: "第 21 项签名留空，打印出来手签。",
    en: "Box 21 is left blank for a signature after printing.",
  },
  "vaRfs.generatedToast": { zh: "已生成并下载", en: "Generated and downloaded" },
  "vaRfs.failedToast": { zh: "生成失败，请再试一次", en: "Could not generate the form — try again" },
  "vaRfs.fillDefaultsFirst": {
    zh: "先把下面的「诊所固定信息」填一次，之后每次就不用再输了。",
    en: "Fill in the clinic details below once — after that they carry over every time.",
  },
  "vaRfs.clinicSection": { zh: "诊所固定信息", en: "Clinic details" },
  "vaRfs.clinicHint": {
    zh: "这些每次都一样，填一次就行：表上 5、7、8、9、19、20 项，以及 6/10/11/12 的固定勾选。",
    en: "Identical on every request — boxes 5, 7, 8, 9, 19, 20, plus the fixed answers to 6, 10, 11 and 12.",
  },
  "vaRfs.providerOffice": { zh: "5. 诊所名称", en: "5. Provider office name" },
  "vaRfs.providerOfficeLine2": { zh: "5. 诊所地址", en: "5. Provider address" },
  "vaRfs.phone": { zh: "7. 电话", en: "7. Phone" },
  "vaRfs.fax": { zh: "8. 传真", en: "8. Fax" },
  "vaRfs.email": { zh: "9. 安全邮箱", en: "9. Secure email" },
  "vaRfs.providerName": { zh: "19. 医师姓名", en: "19. Ordering provider name" },
  "vaRfs.npi": { zh: "20. NPI", en: "20. NPI" },
  "vaRfs.defaultVaFacility": { zh: "3. VA 机构(默认)", en: "3. VA facility (default)" },
  "vaRfs.defaultCpt": { zh: "15. CPT 码(默认)", en: "15. CPT code (default)" },
  "vaRfs.cptDescription": { zh: "16. CPT 描述", en: "16. CPT description" },
  "vaRfs.defaultReason": { zh: "18. 默认申请理由", en: "18. Default reason" },
  "vaRfs.revisionNote": {
    zh: "底稿用的是 VA Form 10-10172（{revision} 版）。VA 换版的话要换这份底稿并核对填字位置。",
